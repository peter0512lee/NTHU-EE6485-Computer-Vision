...
from utils.loss import ComputeLoss, ComputeLossOTA, FocalLoss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str,
                        default='citycam.yaml', help='data.yaml path')
    parser.add_argument(
    ...
    parser.add_argument('--freeze', nargs='+', type=int,
                        default=[0], help='Freeze l ayers: backbone of yolov7=50, first3=0 1 2')
